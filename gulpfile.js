...
gulp.task('launch-server', gulp.series('compile-sass', function(){
    ...
    gulp.watch(['node_modules/bootstrap/scss/bootstrap.scss', 'src/scss/*.scss'], gulp.series('compile-sass'))
...
//execute js task
gulp.task('default', gulp.series('move-js', 'move-fonts', 'launch-server'))